...
A token is used to verify with the webserver that the user is authenticated

- [ ] What steps can you take in your web apps to keep your data secure?

lock the ability to update/delete information behind an authorization request

- [ ] Describe how web servers work.

web servers "serve" the website to users when requested.
